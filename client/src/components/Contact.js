...
<section class=" py-3 py-md-5">
  <div class="container text-direction ">
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-md-left">
      ...
      <div class="col-12 col-lg-6">
        <div class="bg-white border rounded shadow-sm overflow-hidden">
          ...
          <form onSubmit={handleSubmit}>
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
              <div class="col-12">
                ...
                <input  class="form-control" name="name" value={formData.name} onChange={handleChange} placeholder="Name" required />
              </div>
              <div class="col-12 col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input  class="form-control" name="email" type="email" value={formData.email} onChange={handleChange} placeholder="Email" required/>
                </div>
              </div>
              <div class="col-12 col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input  class="form-control" name="mobilenumber" type="number" value={formData.mobilenumber} onChange={handleChange} placeholder="Mobile Number" required />
                </div>
              </div>
              <div class="col-12">
                <label for="subject" class="form-label">Subject <span class="text-danger">*</span></label>
                <input class="form-control" name="subject" type="text" value={formData.subject} onChange={handleChange} placeholder="Subject" required/>
              </div>
              <div class="col-12">
                <label for="message" class="form-label">Message <span class="text-danger">*</span></label>
                <textarea class="form-control" id="message"  rows="3" name="message" value={formData.message} onChange={handleChange} placeholder="Your Message" required></textarea>
              </div>
              <div class="col-12">
                <div class="d-grid">
         ...
         <div className='mx-5 my-2' >{status && <p>{status}</p>}</div> 
        </div>
      </div>
    </div>
  </div>
